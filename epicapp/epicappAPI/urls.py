...
urlpatterns = [
    ...
    path('authors/<path:author_id>/posts/<str:post_id>/',
         views.PostView.as_view(), name='post_endpoint'),
    path('authors/<path:author_id>/posts/<str:post_id>/image/',
         views.PostImageView.as_view(), name='post_image_endpoint'),
    path('authors/<path:author_id>/posts/<str:post_id>/comments',
         views.CommentsView.as_view(), name="comments endpoint"),
    path('authors/<path:author_id>/posts/<str:post_id>/likes/',
         views.LikesView.as_view(), name="post likes endpoint"),
    path('authors/<path:author_id>/posts/<str:post_id>/comments/<str:comment_id>/likes',
